...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { name: "description", content: "Dong Tools is a collection of practical utilities created by a professional photographer for daily work needs." },
        { property: "og:description", content: "Dong Tools is a collection of practical utilities created by a professional photographer for daily work needs." },
        { name: "twitter:description", content: "Dong Tools is a collection of practical utilities created by a professional photographer for daily work needs." },
        { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3e380586-fc2d-4ee0-bb4e-678a234fe25c/id-preview-fe60cc08--cce0c042-1f90-472a-8404-863d2c700d7f.lovable.app-1784029977166.png" },
        { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3e380586-fc2d-4ee0-bb4e-678a234fe25c/id-preview-fe60cc08--cce0c042-1f90-472a-8404-863d2c700d7f.lovable.app-1784029977166.png" },
      ],
      links: [
